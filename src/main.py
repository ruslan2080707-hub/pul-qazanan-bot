...
# Настройка планировщика призов
prize_scheduler = None
try:
    from src.scheduler import setup_scheduler
    prize_scheduler = setup_scheduler()
    logger.info("[MAIN] Prize scheduler initialized successfully")
except Exception as e:
    logger.error(f"[MAIN] Warning: Prize scheduler setup failed: {e}")
    prize_scheduler = None
